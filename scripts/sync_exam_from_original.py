...
EXPLANATION_FIXES: dict[str, dict[str, str]] = {
    "2024": {
        ...
        "q33": "In JavaScript, `typeof NaN` evaluates to `\"number\"` because `NaN` is a numeric value.",
        ...
        "q55": "Both `copy()` and `dict()` shallow-copy a dictionary, so both methods in options a and b are valid.",
        "q78": "With depth 1, `flat()` yields `[1, 2, 3, [4, 5, 6], 7, 8]`. `document.writeln` coerces the array to a string; nested arrays join with commas, producing `1,2,3,4,5,6,7,8`.",
...
QUESTION_TEXT_FIXES: dict[str, dict[str, str]] = {
    ...
    "2024": {
        ...
        "q41": "41. Which is the correct HTML statement to display <del>Hello</del> <u>Hi</u> in a paragraph?",
        "q15": "15. What will be the output of this code?\nconst VALUE=10;\nVALUE=20;",
        "q17": "17. What will be the value of X?\nvar X=10;\nfunction myfunc()\n{\nlet x=20;\n}\ndocument.write(X);",
        "q18": "18. What is the output of the following JavaScript code?\nvar a=10+20+\"5\";\ndocument.getElementById(\"demo\").innerHTML = a;",
        "q19": "19. What will be the output of the following JavaScript code?\nvar x = 1234;\ndocument.getElementById(\"test\").innerHTML = typeof(x);",
        "q21": "21. What will be the output of the following JavaScript code?\nvar numbers = [1, 2, 3, 4];\nfunction myfunc(total, value) {\nreturn total + value;\n}\nvar sum = numbers.reduce(myfunc, 2);",
        "q22": "22. What will be the output of the following JavaScript code?\nvar numbers = [170, 50, 25];\nfunction myfunc(total, value) {\nreturn total - value;\n}\nvar x = numbers.reduce(myfunc);\ndocument.write(x);",
        "q24": "24. What will be the output of the following JavaScript code?\nconst arr = [10, 20, 30];\nlet result = 0;\narr.forEach(myFunction);\ndocument.write(\"Result: \", result);\nfunction myFunction(value, index, array) {\nresult += value;\n}",
        "q25": "25. What will be the output of the following JavaScript code?\nconst values = [10, 20, 30];\nconst result = values.map(myFunction);\ndocument.write(\"Result: \", result);\nfunction myFunction(value, index, array) {\nreturn value * value;\n}",
        "q29": "29. What will be the output of the following JavaScript code?\ntry {\nconst cars = {\ncompany: \"Honda\",\ncolor: \"white\"\n};\nvar x = \"color\";\ndelete cars.company;\ndocument.write(cars.company);\ndocument.write(cars[x]);\n} catch (err){\ndocument.write(err.message);\n}",
        "q30": "30. What will be the output of the following JavaScript code?\nlet x = 10;\nlet y = 20;\nlet text = \"x * y\";\nlet result = eval(text);\ndocument.getElementById(\"demo\").innerHTML = result;",
        "q31": "31. What will be the output of this JavaScript code?\nvar numbers = [10, 20, 30];\nfunction myFunction(value, index, array) {\nreturn value > 10;\n}\nvar y = numbers.filter(myFunction);\ndocument.write(typeof(y));",
        "q32": "32. What will be the output of this JavaScript code?\nvar numbers = [10, 20, 10, 30];\nvar y = numbers.lastIndexOf(10);\nvar z = numbers.indexOf(30);\ndocument.write(y + z);",
        ...
        "q35": "35. What will be the output of the following JavaScript code?\nvar a = 0;\nfor (a=0; a<5; a++);\ndocument.write(a);",
        "q37": "37. What will be the output of the following Python code?\nnewtuple = (1, 2, 3, 4)\n(x, *k, y) = newtuple\nprint(k)",
        "q52": "52. What will be the output of the following Python code?\nfruits = {\"apple\", \"banana\", \"cherry\"}\nfruits.add(\"apple\")\nx = len(fruits)\nprint(x)",
