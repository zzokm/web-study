...
export default function HomePage() {
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-8">
      <div>
        <h1 className="text-3xl font-semibold tracking-tight">Management Study</h1>
        <p className="mt-2 text-muted-foreground">
          Practice finals questions by lecture or exam year, review repetitive high-yield
          items, and jump to lecture slides.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardDescription>Repetitive stems</CardDescription>
            <CardTitle className="text-3xl tabular-nums">{stats.repetitive}</CardTitle>
          </CardHeader>
        </Card>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <LinkButton href="/repetitive/" variant="outline" size="sm">
            Repetitive ({stats.repetitive})
          </LinkButton>
