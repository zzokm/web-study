/**
 * Lists fields on the feedback Google Form.
 * Run: node scripts/inspect-feedback-form.mjs
 */

const url =
  "https://docs.google.com/forms/d/e/1FAIpQLSfBiJXyAAXxykycB2fRpCUBfBBenziAI-zs3eCUk3Q0UoNjgw/viewform";
